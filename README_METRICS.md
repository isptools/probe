...
Uma implementação completa de métricas Prometheus para monitoramento avançado da ISP Tools Probe v2.2.7+.
...
probe_version="2.2.7"      # Versão da probe
...
**Versão:** 1.0.0  
**Compatível com:** ISP Tools Probe v2.2.7+  
